...
- (void)didReceiveMemoryWarning
{
    ...
    [self.currentIconDownloads removeAllObjects];
        NSLog(@"Received memory warning content");
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([content isKindOfClass:[AGSPortalGroup class]])
    {
        ...
        }else if (portalGroup.thumbnailFileName != nil && [portalGroup.thumbnailFileName isEqualToString: @""])
        {
    ...
    if ([content isKindOfClass:[AGSPortalItem class]])
    {
       ...
       //UISwitch *switchview = [[UISwitch alloc] initWithFrame:CGRectZero];
        itemTableViewCell.accessoryView = UITableViewCellAccessoryNone;
