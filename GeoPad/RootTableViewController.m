...
//    else
//    {
       // return @"Maps in Documents Directory";
//    }
return @"";
}
...
//    }
    ...
    [self.delegate usertaponoffmap:tilePackage];
    
    
  //  OnlineOfflineEditingSampleViewController *viewController =[[OnlineOfflineEditingSampleViewController alloc]initWithNibName:@"OnlineOfflineEditingSampleViewController" bundle:nil];
