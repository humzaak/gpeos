...
- (void)didReceiveMemoryWarning
{
    ...
    [super didReceiveMemoryWarning];
        NSLog(@"Received memory warning pe");
...
//    }
//    else if(indexPath.section == kEOSSection)
//    {
//        return kEOSrowsize;
//        
//    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
   ...
   // static NSString *groupsAndContentsCellIdentifier = @"GroupsAndContentsCell";
    static NSString *EOSCellIdentifier = @"EOSCell";
...
//            
            ...
            UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(8, -8, 288, 64)];
...
//        
        ...
        label.text = self.portal.portalInfo.organizationId ? self.portal.portalInfo.organizationName : @"My Organization (Sign In to View)";
    ...
    else if (indexPath.section == kEOSSection)
    {
        ...
        cell = [tableView dequeueReusableCellWithIdentifier:EOSCellIdentifier];
        
        if (cell == nil)
        {
            cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:EOSCellIdentifier];
            cell.selectionStyle = UITableViewCellSelectionStyleNone;
            
            //add organization thumbnail view
//            UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(8, 8, 64, 64)];
//            imageView.contentMode = UIViewContentModeScaleAspectFit;
//            imageView.tag = kImageViewTag1;
//            if ([imageView.layer respondsToSelector:@selector(setShadowColor:)])
//            {
//                imageView.layer.shadowColor = [UIColor blackColor].CGColor;
//                imageView.layer.shadowOpacity = 0.8;
...
//            //add organization title
        ...
        //set the thumbnail image if it exists in the portal info otherwise set it to the default one.
//        UIImageView *imageView = (UIImageView *)[cell viewWithTag:kImageViewTag1];
//        if(self.portal.portalInfo.organizationThumbnail)
//        {
//            imageView.image = self.portal.portalInfo.organizationThumbnail;
//        }
...
//        
        //set the title
        UILabel *label = (UILabel *)[cell viewWithTag:kTitleTag];
        label.text = @"Earth Observatory of Singapore";
        //label.text = self.portal.portalInfo.organizationId ? self.portal.portalInfo.organizationName : @"Earth Observatory of Singapore";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == kOrganizationSection)
    {
        OrganizationDetailsViewController *organizationDetailsVC = [[OrganizationDetailsViewController alloc] initWithPortalInfo:self.portal.portalInfo andportal:self.portal andcredential:self.portal.credential];
    ...
    else if (indexPath.section == kEOSSection)
    {
      ...
      //  EOSViewViewController *eosdetailsVC = [[EOSViewViewController alloc]init];
        
        SearchViewController *searchVC = [[SearchViewController alloc] initWithPortal:self.portal];
        [searchVC dosearch];
        
        
        [searchVC setTitle:@"Earth Observatory of Singapore"];
        [self.navigationController pushViewController:searchVC animated:YES];

//        OrganizationDetailsViewController *organizationDetailsVC = [[OrganizationDetailsViewController alloc] initWithPortalInfo:self.portal.portalInfo andportal:self.portal andcredential:self.portal.credential];
//        [organizationDetailsVC setTitle:@"Earth Observatory of Singapore"];
//        nextViewController = organizationDetailsVC;
//        [self.navigationController pushViewController:nextViewController animated:YES];
