...
-(void) dosearch{
    ...
    [self searchBarSearchButtonClickedwithtext:@"EOS Public Group"];
...
- (void)searchBarSearchButtonClickedwithtext:(NSString *)text
{
    //create the query params for the items. 
//	AGSPortalQueryParams *itemsQueryParams = [AGSPortalQueryParams queryParamsWithQuery:[NSString stringWithFormat:@"%@",text]];
//    [self searchForItemsWithQueryParams:itemsQueryParams];
//    
    //create the query params for the groups.
    AGSPortalQueryParams *groupsQueryParams = [AGSPortalQueryParams queryParamsWithQuery:[NSString stringWithFormat:@"%@",text]];
